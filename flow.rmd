...
## **System Overview**
This is a **Data Validation Agent** that automatically detects business signals (expansion, hiring, scheduling) from websites and generates personalized outreach emails. It uses a multi-agent architecture with LLM-powered agents working in sequence.
...
- **Function**:
  ...
  2. Adds random delay to avoid rate limiting
  3. Makes HTTP request with proper headers
