...
def draft_from_card(llm: OllamaChat, *, company: str, domain: str, signal_type: str, url: str, snippet: str, confidence: float):
    ...
    if not m:
        return EmailDraft(subject="Quick idea after your recent update", body=f"Hi — noticed: {snippet}\n\nWe help teams act on this signal. Open to a 10-minute walkthrough?", call_to_action="Open to a 10-minute walkthrough?")
